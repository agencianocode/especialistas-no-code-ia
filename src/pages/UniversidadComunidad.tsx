...
export default function UniversidadComunidad() {
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-white">
      ...
      <div className="fixed left-0 top-0 w-full sm:w-64 h-full bg-neutral-800 border-r border-neutral-700 z-40 transform transition-transform duration-300 lg:translate-x-0">
        {/* Logo */}
        <div className="p-4 sm:p-6 border-b border-neutral-700">
          <div className="flex items-center">
            ...
            <Badge variant="secondary" className="ml-2 text-xs bg-neutral-600 text-white hidden sm:block">
              BETA
            </Badge>
          </div>
        </div>
        ...
        <nav className="p-4 flex-1 overflow-y-auto">
          {sidebarItems.map((item) => (
            <button
              ...
              className={`w-full flex items-center px-3 py-2 mb-1 text-sm rounded-lg transition-colors min-h-[44px] ${
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <div className="flex items-center p-3 bg-neutral-700 rounded-lg">
            <div className="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center mr-3 relative flex-shrink-0">
            ...
            <div className="flex-1 min-w-0 hidden sm:block">
              <div className="text-sm font-medium truncate">fabianiela</div>
            ...
            <div className="flex gap-1 flex-shrink-0">
              <Button 
                variant="ghost" 
                size="sm" 
                className="p-1 text-yellow-400 hover:text-yellow-300 min-h-[32px] min-w-[32px]"
      ...
      <div className="ml-0 sm:ml-64 flex flex-col lg:flex-row h-screen">
        {/* Channels Sidebar - Responsive */}
        <div className="w-full lg:w-80 bg-neutral-800 border-r border-neutral-700 flex flex-col">
          {/* Community Header */}
          <div className="p-4 border-b border-neutral-700">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-neutral-400 hidden sm:block">Conectado</span>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-1">
                  {category.channels.map((channel) => (
                    ...
                    >
                      ...
                      {channel.count > 0 && (
                        <Badge variant="secondary" className="bg-neutral-600 text-white text-xs flex-shrink-0">
                          {channel.count}
                        </Badge>
                      )}
                    </button>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h3 className="font-semibold truncate">General</h3>
                  <p className="text-sm text-neutral-400 hidden sm:block truncate">Conversaciones generales sobre IA</p>
                </div>
              </div>
              <div className="flex items-center gap-2 flex-shrink-0">
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="text-neutral-400 hover:text-white min-h-[36px] min-w-[36px] p-1"
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="text-neutral-400 hover:text-white min-h-[36px] min-w-[36px] p-1 hidden sm:flex"
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="text-neutral-400 hover:text-white min-h-[36px] min-w-[36px] p-1 hidden md:flex"
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="text-neutral-400 hover:text-white min-h-[36px] min-w-[36px] p-1 hidden lg:flex"
                  aria-label="Miembros"
                >
          ...
          <div className="p-4 border-t border-neutral-700">
            <div className="relative">
              <input
                ...
                className="w-full bg-neutral-700 border border-neutral-600 rounded-lg px-4 py-3 pr-20 text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-purple-500 min-h-[48px]"
              ...
              <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex gap-1">
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="text-neutral-400 hover:text-white p-1 min-h-[32px] min-w-[32px] hidden sm:flex"
                ...
                <Button 
                  ...
                  variant="ghost" 
                  size="sm" 
                  className="text-purple-400 hover:text-purple-300 p-1 min-h-[32px] min-w-[32px]"
        ...
        <div className={`${activeThread ? 'hidden xl:block xl:w-48' : 'hidden lg:block lg:w-64'} bg-neutral-800 border-l border-neutral-700 p-4 transition-all duration-200`}>
          <h3 className="font-semibold mb-4 text-balance">Miembros en línea ({onlineUsers.length})</h3>
          <div className="space-y-2">
            {onlineUsers.map((user, index) => (
              <div key={index} className="flex items-center gap-3 p-2 rounded-lg hover:bg-neutral-700 transition-colors cursor-pointer min-h-[44px]">
